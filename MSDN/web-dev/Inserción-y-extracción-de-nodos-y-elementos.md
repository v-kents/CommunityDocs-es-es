...
![] (./img/Inserción-y-extracción-de-nodos-y-elementos/image1.png)
...
![] (./img/Inserción-y-extracción-de-nodos-y-elementos/image2.png)

Estado inicial del DOM, antes de pulsar el botón de comando

![] (./img/Inserción-y-extracción-de-nodos-y-elementos/image3.png)
...
![] (./img/Inserción-y-extracción-de-nodos-y-elementos/image4.png)
...
![] (./img/Inserción-y-extracción-de-nodos-y-elementos/image5.png)
...
![] (./img/Inserción-y-extracción-de-nodos-y-elementos/image6.png)

El DOM antes de ejecutar las acciones

![] (./img/Inserción-y-extracción-de-nodos-y-elementos/image7.png)
...
![] (./img/Inserción-y-extracción-de-nodos-y-elementos/image8.png)
